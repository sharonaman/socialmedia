...
<% 
    ...
    <div class="header_section">
     ...
              </form>
            ...
            <li class="nav-item">
              ...
              <input type="hidden" name="id" value="<%= id %>">
              <input type="hidden" name="uname" value="<%= uname %>">
              <input type="hidden" name="action" value="adminfeed">
     ...
              </form>
            ...
            <li class="nav-item  active">
              ...
              <input type="hidden" name="id" value="<%= id %>">
              <input type="hidden" name="uname" value="<%= uname %>">
              <input type="hidden" name="action" value="adminpeople">
     ...
              </form>
            ...
            <li class="nav-item">
              ...
              <input type="hidden" name="id" value="<%= id %>">
              <input type="hidden" name="uname" value="<%= uname %>">
              <input type="hidden" name="action" value="deletedposts">
              <button type="submit" class="one">DELETED POST</button>
              </form>
            </li>
            <li class="nav-item">
    ...
    <!-- header section end -->
    <%
    ArrayList<Variable> data=(ArrayList<Variable>) session.getAttribute("person");
    for(Variable people:data)
    {
  ...
  <div class="container">
    <h4><b><%=people.getName() %></b></h4>
    <form action="Controller" method="post">
    <button style='font-size:24px'><i class='far fa-comments'></i></button>
    <input type="hidden" name="id" value="<%= id %>">
    <input type="hidden" name="uname" value="<%= uname %>">
    <input type="hidden" name="rid" value="<%=people.getId() %>">
    <input type="hidden" name="rname" value="<%=people.getName() %>">
